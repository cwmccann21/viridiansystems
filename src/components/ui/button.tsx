...
type ButtonOrLinkProps =
  ...
  | (Omit<React.ComponentPropsWithoutRef<typeof Slot>, 'asChild'> & { asChild: true });

const Button = React.forwardRef<any, ButtonOrLinkProps & VariantProps<typeof buttonVariants>>(
